...
# patch audio effects
LIB=libvafx_cc_sfx.so
LIBNAME=vafx_cc_sfx
NAME=vafx_cc
UUID=40050b20-6999-11e0-b0d8-0002a5d5c52a
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
LIBNAME=vafxvcp
NAME=vafxvcp
UUID=40050b20-6999-11e0-b0d8-0002a5d5c526
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
LIBNAME=vafx_vg
NAME=vafxvoicegain
UUID=40050b20-6999-11e0-b0d8-0002a5d5c52c
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
# patch audio effects
LIB=libvafx_hp_sfx.so
LIBNAME=vafx_hp_sfx
NAME=vafx_hp_sfx
UUID=40050b20-6999-11e0-b0d8-0002a5d5c534
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
LIBNAME=vafx_gfx
NAME=vafx_gfx
UUID=40050b20-6999-11e0-b0d8-0002a5d5c536
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
# patch audio effects
LIB=libvafx_spacefx.so
LIBNAME=vafx_spacefx
NAME=vafx_spacefx
UUID=40050b20-6999-11e0-b0d8-0002a5d5c538
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
...
# patch audio effects
LIB=libvafx_spkr_sfx.so
LIBNAME=vafx_spkr_sfx
NAME=vafx_spkr_sfx
UUID=40050b20-6999-11e0-b0d8-0002a5d5c530
RMVS="$LIB $LIBNAME $NAME $UUID"
archdir
if [ "$ARCHDIR" ]; then
  for MODAEC in $MODAECS; do
